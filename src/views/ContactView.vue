...
<template>
    ...
    <div class="background">
        <h1 class="heading animate__animated animate__zoomInUp">Contact</h1>
...
body {
    background-image: url(https://i.postimg.cc/CMZSJ2LN/aot3bg.jpg);
...
.card {
  ...
  /* background-color: rgb(255, 196, 206) !important; */
}
</style>
  <style scoped>
   * {
